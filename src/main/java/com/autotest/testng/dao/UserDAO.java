package com.autotest.testng.dao;

import com.autotest.testng.model.Course; // Keep if needed for other methods like getJoinedCourses
import com.autotest.testng.utils.DatabaseUtil;
