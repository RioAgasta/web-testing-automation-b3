...
public class MyCourseLocators {
  ...
  // Empty State Messages
  public static final By EMPTY_STATE_MESSAGE_IN_PROGRESS = By
      .xpath("//div[@id='inprogress']//p[contains(text(), 'Belum ada kursus yang sedang dijalani.')]");
  public static final By EMPTY_STATE_MESSAGE_COMPLETED = By
      .xpath("//div[@id='completed']//p[contains(text(), 'Belum ada kursus yang selesai.')]");

  // get loggedin username
  public static final By LOGGED_IN_USERNAME = By.cssSelector("li.nav-name.dropdown > a.nav-link"); // Assuming the
                                                                                                   // username is
                                                                                                   // displayed in a
                                                                                                   // navbar text
                                                                                                   // element
